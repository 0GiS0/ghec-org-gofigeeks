...
metadata:
  ...
  title: 🧰 MCP Server Node.js
  description: Create a Model Context Protocol (MCP) Node.js server project
  annotations:
...
spec:
  ...
  type: service
  parameters:
    - title: 🧰 Complete the form to create a new MCP Server using Node.js
      required:
        - name
        - description
        - system
